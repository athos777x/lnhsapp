...
const BarcodeImage = ({ value }: { value: string }) => {
  ...
  const getBarcodeUrl = (studentId: string) => {
    ...
    return `https://barcode.tec-it.com/barcode.ashx?data=${studentId}&code=Code128&translate-esc=on&dpi=96&height=60&width=0&quietzone=0`;
  };
  ...
  return (
    <View style={styles.barcodeWrapper}>
      ...
      {/* Add small attribution as required */}
      <Text style={styles.attribution}>
        Generated by TEC-IT Barcode Generator
      </Text>
    </View>
  );
};
